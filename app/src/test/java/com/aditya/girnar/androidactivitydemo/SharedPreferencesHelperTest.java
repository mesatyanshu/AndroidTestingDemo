...
import com.aditya.girnar.androidactivitydemo.Activities.SharedPreferenceEntry;
import com.aditya.girnar.androidactivitydemo.Activities.SharedPreferencesHelper;
...
/**
 * Created by Satyanshu on 2/18/2016.
 */

@SmallTest
@RunWith(MockitoJUnitRunner.class)
public class SharedPreferencesHelperTest extends TestCase {
    ...
    private static final String FAIL_TEST_NAME = "Test name";

    private static final String FAIL_TEST_EMAIL = "test@email.com";

    private static final Calendar FAIL_TEST_DATE_OF_BIRTH = Calendar.getInstance();
